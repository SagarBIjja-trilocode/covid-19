...
import com.example.covid_19_app.Models.Indiadata
import com.example.covid_19_app.Retrofit.RetrofitServiceForpak
import com.example.covid_19_app.common.CommonFroPakdata
import kotlinx.android.synthetic.main.fragment_india_fragment.*
import kotlinx.android.synthetic.main.fragment_india_fragment.view.*
...
class Pakistan_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v=inflater.inflate(R.layout.fragment_india_fragment, container, false)
    ...
    private fun getdataandshow(v: View?) {
        ...
        mServices.getpakdataService(url).enqueue(object :retrofit2.Callback<Indiadata>{
            override fun onFailure(call: Call<Indiadata>, t: Throwable) {
                Toast.makeText(context,"No Internet Failed To upload Data",Toast.LENGTH_LONG).show()

            }

            override fun onResponse(call: Call<Indiadata>, response: Response<Indiadata>) {
